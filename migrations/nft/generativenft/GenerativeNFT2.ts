...
class GenerativeNFT2 {
    ...
    async deploy(admin: any) {
        ...
        const nft = await ethers.getContractFactory("GenerativeNFT2");
        const nftDeployed = await nft.deploy("", "", admin);

        console.log("GenerativeNFT2 template contract deployed:", nftDeployed.address);
    ...
    getContract(contractAddress: any) {
        ...
        // load contract
        let contract = require(path.resolve("./artifacts/contracts/nft/GenerativeNFT2.sol/GenerativeNFT2.json"));
